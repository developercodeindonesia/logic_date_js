...
// day of the week
weekArray: ['Mi', 'Se', 'Se', 'Ra', 'Ka', 'Ju', 'Sa'],
...
onClose: $.noop
        ...
        TEMPLATE = [
            ...
            '<span class="prev" title="Prev" data-calendar-arrow-date>{prev}</span>',
            '<span class="next" title="Next" data-calendar-arrow-date>{next}</span>',
            '</div>',
            '</div>',
            ...
            '<div class="calendar-arrow">',
            '<span class="prev" title="Prev" data-calendar-arrow-month>{prev}</span>',
            '<span class="next" title="Next" data-calendar-arrow-month>{next}</span>',
            '</div>',
            '</div>',
